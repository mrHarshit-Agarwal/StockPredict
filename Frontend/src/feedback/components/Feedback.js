...
class Feedback extends Component {
	...
	handleSubmit() {
		...
		if (isEmpty(this.state.nameInput) || isEmpty(this.state.emailInput) || isEmpty(this.state.messageInput) ) {
			...
			this.setState({ showForm: false, nameInput: '', messageInput: '', emailInput: '' });
			handleClose();
		}
	}
	handleClose() {
